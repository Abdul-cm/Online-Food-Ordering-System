...
// Check if the user is logged in by verifying the session variable 'fosuid'
if (strlen($_SESSION['fosuid'] == 0)) {
    // If the user is not logged in, redirect them to the logout page
    header('location:logout.php');
} else {
    // If the user is logged in, continue executing the rest of the code
}
?>
...
echo $status;
                                                    ...
                                                    ?> (<a href="javascript:void(0);"
                                                        ...
                                                        title="Track order" style="color:red;"><i
                                                            class="flaticon-transport"></i> Track Order</a>)</td>
                                            </tr>
                                            <tr>
                                                <th colspan="4" style="text-align:center;color:blue; font-size:20px;">
                                                    Delivery Address</th>
                                            </tr>
                                            <tr>
                                        ...
                                        <p style="font-weight:bold; font-size:18px;"><a href="javascript:void(0);"
                                                onClick="popUpWindow('invoice.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');"
                                                title="Order Invoice" style="color:red">Invoice</a> |
