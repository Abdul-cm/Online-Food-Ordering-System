            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <img alt="image" class="rounded-circle" src="img/male.png"/>
...
?>
                ...
                <li>
                    <a href="#"><i class="fa fa-file"></i> <span class="nav-label">Food Category</span><span class="fa arrow"></span></a>
 ...
 <li>
                    <a href="#"><i class="fa fa-file"></i> <span class="nav-label">Food Menu</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="search.php"><i class="fa fa-search"></i> <span class="nav-label">Search</span> <span class="fa arrow"></span></a>
                                    </li>
                                    <li>
