...
// Check if the form has been submitted with an 'addcart' button
if (isset($_POST['addcart'])) {
    // Retrieve the food ID, food quantity, and user ID from the submitted data
    $foodid = $_POST['foodid'];
    $foodqty = $_POST['foodqty'];
    $userid = $_SESSION['fosuid'];

    // Insert the data into the 'tblorders' table in the database
    $query = mysqli_query($con, "insert into tblorders(UserId, FoodId, FoodQty) values('$userid', '$foodid', '$foodqty')");

    // Check if the insertion was successful
    if ($query) {
        // If successful, show an alert indicating that the food has been added to the cart
            ...
            <div class="page-title-wrapper text-center">
                <div class="col-md-12 col-sm-12 col-lg-12">
                    <div class="page-title-inner">
                        <h1 itemprop="headline">Search Results against keyword "<?php echo $_POST['searchdata']; ?>"
                        </h1>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                                            <div class="popular-dish-thumb">
                                                <a href="food-detail.php?fid=<?php echo $row['ID']; ?>" title=""
                                                    itemprop="url"><img
                                                        src="admin/itemimages/<?php echo $row['Image']; ?>"
                                                        alt="<?php echo $row['ItemName']; ?>" itemprop="image"
...
<ul class="pagination"> -->
                                    ...
                                    <li class="page-item next"><a class="page-link brd-rd2"
                                            href='?page_no=<?php echo $total_no_of_pages; ?>'>Last &rsaquo;&rsaquo;</a>
                                    </li>
                                    <?php
                                    } ?>
