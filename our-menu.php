...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
  ...
  <a class="log-popup-btn btn  pull-right bg-primary brd-rd3" href="#" title="Login">Order Now</a>
<?php } else {?>
<button type="submit" name="addcart" class="btn  pull-right bg-primary brd-rd3">Order Now</button>
                                                <?php } ?>
                                        </form>
                                            </div>
