...
if (isset($_POST['submit'])) {
    ...
    if ($result > 0) {
        // Display an error message if the email or mobile number already exists
        ...
        if ($query) {
            // Display a success message if the user's information was successfully inserted into the database
            echo "<script>alert('You have successfully registered');</script>";
            echo "<script>window.location.href='index.php'</script>";
        } else {
            // Display an error message if there was an error inserting the user's information into the database
            ...
            <form class="sign-form" name="signup" onsubmit="return checkpass();" method="post">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        ...
                        <a class="recover-btn" href="forgot-password.php" title="" itemprop="url">Recover my
                            password</a>
                    </div>
                </div>
            </form>
