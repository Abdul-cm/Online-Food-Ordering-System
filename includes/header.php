...
error_reporting(0);
            ...
            <div class="topbar">
                <div class="container">
                    ...
                    <div class="topbar-register">
                        ...
                        <a class="log-popup-btn" href="#" title="Login" itemprop="url" style="display: inline-block; padding: 10px 20px; border-radius: 30px; font-size: 16px; font-weight: bold; text-align: center; text-decoration: none; color: #fff; background-color: #ff6b6b; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3); transition: all 0.3s ease;">LOGIN</a> <span class="separator" style="margin: 0 10px; color: #999;">/</span> <a class="sign-popup-btn" href="#" title="Register" itemprop="url" style="display: inline-block; padding: 10px 20px; border-radius: 30px; font-size: 16px; font-weight: bold; text-align: center; text-decoration: none; color: #fff; background-color: #ff6b6b; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3); transition: all 0.3s ease;">REGISTER</a>
                <?php }?>
                     <?php if (strlen($_SESSION['fosuid']>0)) {?>
   <a  href="my-account.php" title="My Account" itemprop="url">My Account</a>
            ...
            <div class="logo-menu-sec">
                <div class="container">
                    <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url"></a></h1></div>
                    <nav>
                        <div class="menu-sec">
                            <ul>
...
<li><a href="contact-us.php" title="Contact us" itemprop="url">Contact us </a></li>
         ...
         <?php if (strlen($_SESSION['fosuid']==0)) {?> 
                    <a class="log-popup-btn bg-primary brd-rd4" href="#" title="Login" itemprop="url">My Cart</a> 
                <?php }?>

                                   <?php if (strlen($_SESSION['fosuid']>0)) {?>
                            <a class="bg-primary brd-rd4" href="cart.php" title="Register" itemprop="url">My Cart</a>
                        <?php } ?>
