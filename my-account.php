...
// Check if the user is not logged in, then redirect to logout
if (strlen($_SESSION['fosuid']) == 0) {
    ...
    if (isset($_POST['changepassword'])) {
        ...
        // If the current password is correct, update it with the new password
        if ($row > 0) {
...
?>  
                                       ...
                                       <div class="user-info bg-primary">
                                          <img class="brd-rd50" src="assets/images/user.png" alt="user-avatar.jpg" itemprop="image">
              ...
              { ?>  
                                             ...
                                             <div class="order-item brd-rd5">
                                                <div class="order-thumb brd-rd5">
                                                   <a href="#" title="" itemprop="url"><img src="assets/images/order-1.png" alt="order-img1.jpg" itemprop="image"></a>
